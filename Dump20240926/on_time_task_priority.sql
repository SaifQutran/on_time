...
CREATE TABLE `task_priority` (
  ...
  `priority_color` varchar(7) NOT NULL DEFAULT '#ffffff',
...
INSERT INTO `task_priority` VALUES (1,'عادية','#999999'),(2,'متوسطة','#e4e422'),(3,'مهمة','#ff3300');
...
-- Dump completed on 2024-09-26 17:58:30
