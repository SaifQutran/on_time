...
CREATE TABLE `groups_` (
  ...
  `group_color` varchar(7) NOT NULL DEFAULT '#3a3a3a',
...
INSERT INTO `groups_` VALUES (1,'المجموعة الأولى','#FF5733'),(2,'المجموعة الثانية','#33FF57'),(3,'المجموعة الثالثة','#3357FF'),(4,'المجموعة الرابعة','#F1C40F'),(5,'المجموعة الخامسة','#8E44AD'),(18,' البادية','#34ee23'),(19,' تجربة','#3a3a3a');
...
-- Dump completed on 2024-09-26 17:58:43
